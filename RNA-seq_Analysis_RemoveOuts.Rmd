...
sample_names <- c("1373-liver", "1373-lung", "1394-liver", "1394-lung", "1398-liver", "1398-lung", "1399-liver", "1399-lung", "1548-lung", "6843-liver", "6843-lung", "6844-liver", "6844-lung", "997-lung")
...
write.csv(final, "combined_RNA_TPM_export_removed_Outs.csv", row.names = FALSE)
...
# Compare NFIB-fl/fl Liver met v. Primary
res <- results(dds, contrast=c("Group", "TKO;Nfib-fl/fl + Ad-CMV-Cre + Liver", "TKO;Nfib-fl/fl + Ad-CMV-Cre + Lung"))
...
resOrdered_withGene <- resOrdered

resOrdered_withGene$gene_id <- rownames(resOrdered_withGene)

resOrdered_withGene <- as.data.frame(resOrdered_withGene) %>% 
  left_join(final %>% dplyr::select(c("gene_id", "gene_name")))

write.xlsx(resOrdered_withGene, "NFIB-fl Met v Primary.xlsx")


# Compare NFIB-wt Liver met v. Primary
res <- results(dds, contrast=c("Group", "TKO;Nfib+/+ + Ad-CMV-Cre + Liver", "TKO;Nfib+/+ + Ad-CMV-Cre + Lung"))
resOrdered <- res[order(res$padj),]
...
write.xlsx(resOrdered_withGene, "NFIB-wt Met v Primary.xlsx")


# Compare NFIB-fl Liver met v. Nfib-wt Liver met
res <- results(dds, contrast=c("Group", "TKO;Nfib-fl/fl + Ad-CMV-Cre + Liver", "TKO;Nfib+/+ + Ad-CMV-Cre + Liver"))
resOrdered <- res[order(res$padj),]
...
write.xlsx(resOrdered_withGene, "NFIB-fl Met v Nfib-wt Met.xlsx")


# Compare NFIB-fl Primary v. NFIB-wt Primary
res <- results(dds, contrast=c("Group", "TKO;Nfib-fl/fl + Ad-CMV-Cre + Lung", "TKO;Nfib+/+ + Ad-CMV-Cre + Lung"))
resOrdered <- res[order(res$padj),]
...
write.xlsx(resOrdered_withGene, "NFIB-fl Primary v NFIB-wt Primary.xlsx")


# Compare NFIB-wt cGRP-Cre Liver met v. Primary
res <- results(dds, contrast=c("Group", "TKO + Ad-cGRP-Cre + Liver", "TKO + Ad-cGRP-Cre + Lung"))
resOrdered <- res[order(res$padj),]
...
write.xlsx(resOrdered_withGene, "cGRP-Cre Met v Primary.xlsx")
...
ggsave("RNA-seq cluster heatmap_less.pdf", plot = cluster_heatmap, height = 4, width = 8)
ggsave("RNA-seq cluster heatmap_less.png", plot = cluster_heatmap, height = 4, width = 8, dpi = 600)
...
ggsave("RNA-seq PCA_less.pdf", plot = base_pca, height = 4, width = 8)
ggsave("RNA-seq PCA_less.png", plot = base_pca, height = 4, width = 8, dpi = 600)
...
generate_NE_hm <- function(heatmap_df){
  ...
  col_colors <- list(Differentiation = c(NE = "#E9A3C9",
                                         `Non-NE` = "#F7F7F7",
                                         `N/A`="#A1D76A"),
                     Group = c(`Naphthalene (200mg/kg) + 1X HIV-PGK-Cre` = "#27B34B",
                               `Naphthalene (200mg/kg) + 1X FIV-CMV-Cre` = "#F8766D",
                               `NT + 1X Ad-CMV-Cre` = "#6F94CD",
                               `NT + 1X HIV-PGK-Cre` = "#984EA3",
                               `NT + 1X FIV-CMV-Cre` = "#FF7F00",
                               `Naphthalene (200mg/kg) + 1X Ad-CMV-Cre` = "#FFFF33"))
...
ggsave("RNA-seq NE heatmap normalized.pdf", plot = hm, height = 10, width = 10)
ggsave("RNA-seq NE heatmap normalized.png", plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave("RNA-seq NE heatmap.pdf", plot = hm, height = 10, width = 10)
ggsave("RNA-seq NE heatmap.png", plot = hm, height = 10, width = 10, dpi = 600)
...
generate_custom_hm <- function(heatmap_df){
  ...
  col_colors <- list(Marker = c(Subtype = "#FFFF33",
                                ...
                                NE = "#E9A3C9",
                                `Non-NE` = "#F7F7F7"),
                     Group = c(`Naphthalene (200mg/kg) + 1X HIV-PGK-Cre` = "#E41A1C",
                               `NT + 1X Ad-CMV-Cre` = "#377EB8",
                               `Naphthalene (200mg/kg) + 1X FIV-CMV-Cre` = "#4DAF4A",
                               `NT + 1X HIV-PGK-Cre` = "#984EA3",
                               `NT + 1X FIV-CMV-Cre` = "#FF7F00",
                               `Naphthalene (200mg/kg) + 1X Ad-CMV-Cre` = "#FFFF33"))
...
write.xlsx(bar_df, "Custom Gene Normalized Counts All.xlsx")
...
ggsave("RNA-seq Selected bar graph.pdf", plot = bar_graph, height = 10, width = 10)
ggsave("RNA-seq Selected bar graph.png", plot = bar_graph, height = 10, width = 10, dpi = 600)
...
ggsave("RNA-seq Selected bar graph normalized.pdf", plot = bar_graph, height = 10, width = 10)
ggsave("RNA-seq Selected bar graph normalized.png", plot = bar_graph, height = 10, width = 10, dpi = 600)
...
ggsave("RNA-seq Selected heatmap normalized.pdf", plot = hm, height = 10, width = 10)
ggsave("RNA-seq Selected heatmap normalized.png", plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave("RNA-seq Selected heatmap.pdf", plot = hm, height = 10, width = 10)
ggsave("RNA-seq Selected heatmap.png", plot = hm, height = 10, width = 10, dpi = 600)
...
generate_DE_hm <- function(heatmap_df){
  ...
  col_colors <- list(Group = c(`Naphthalene (200mg/kg) + 1X HIV-PGK-Cre` = "#E41A1C",
                               `NT + 1X Ad-CMV-Cre` = "#377EB8",
                               `Naphthalene (200mg/kg) + 1X FIV-CMV-Cre` = "#4DAF4A",
                               `NT + 1X HIV-PGK-Cre` = "#984EA3",
                               `NT + 1X FIV-CMV-Cre` = "#FF7F00",
...
ggsave("RNA-seq DE heatmap normalized.pdf", plot = hm, height = 10, width = 10)
ggsave("RNA-seq DE heatmap normalized.png", plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave("RNA-seq DE heatmap.pdf", plot = hm, height = 10, width = 10)
ggsave("RNA-seq DE heatmap.png", plot = hm, height = 10, width = 10, dpi = 600)
