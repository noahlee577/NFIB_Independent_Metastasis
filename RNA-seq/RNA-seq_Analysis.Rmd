...
sample_names <- c("1373-liver", "1373-lung", "1394-liver", "1394-lung", "1398-liver", "1398-lung", "1399-liver", "1399-lung", "1548-lung", "997-lung", "6843-liver", "6843-lung", "6844-liver", "6844-lung")
...
write.csv(final, paste0(results_dir, "combined_RNA_TPM_export.csv"), row.names = FALSE)
...
ggsave(paste0(results_dir, "RNA-seq cluster heatmap.pdf"), plot = cluster_heatmap, height = 4, width = 8)
ggsave(paste0(results_dir, "RNA-seq cluster heatmap.png"), plot = cluster_heatmap, height = 4, width = 8, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq PCA.pdf"), plot = base_pca, height = 4, width = 8)
ggsave(paste0(results_dir, "RNA-seq PCA.png"), plot = base_pca, height = 4, width = 8, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq NE heatmap normalized.pdf"), plot = hm, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq NE heatmap normalized.png"), plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq NE heatmap.pdf"), plot = hm, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq NE heatmap.png"), plot = hm, height = 10, width = 10, dpi = 600)
...
write.xlsx(bar_df, "Custom Gene Normalized Counts.xlsx")
...
ggsave(paste0(results_dir, "RNA-seq Selected bar graph.pdf"), plot = bar_graph, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq Selected bar graph.png"), plot = bar_graph, height = 10, width = 10, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq Selected bar graph normalized.pdf"), plot = bar_graph, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq Selected bar graph normalized.png"), plot = bar_graph, height = 10, width = 10, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq Selected heatmap normalized.pdf"), plot = hm, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq Selected heatmap normalized.png"), plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq Selected heatmap.pdf"), plot = hm, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq Selected heatmap.png"), plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq DE heatmap normalized.pdf"), plot = hm, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq DE heatmap normalized.png"), plot = hm, height = 10, width = 10, dpi = 600)
...
ggsave(paste0(results_dir, "RNA-seq DE heatmap.pdf"), plot = hm, height = 10, width = 10)
ggsave(paste0(results_dir, "RNA-seq DE heatmap.png"), plot = hm, height = 10, width = 10, dpi = 600)
